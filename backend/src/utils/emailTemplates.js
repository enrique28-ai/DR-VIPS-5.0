...
const COPY = {
  en: {
    ...
    resetOk: {
      ...
      p2: "If you did not make this change, please reset your password immediately and contact support.",
    },
    welcome: {
      title: "Welcome to DR-VIPS",
      p1: "We’re excited to have you on",
      p2: "You now have access to a fast, modern workspace to manage patients and diagnoses.",
      tip: "Tip: complete your profile and start adding your first patients when you sign in.",
...
resetCode: {
  ...
  es: {
    ...
    resetOk: {
      ...
      p2: "Si tú no realizaste este cambio, restablece tu contraseña de inmediato y contacta soporte.",
    },
    welcome: {
      title: "Bienvenido a DR-VIPS",
      p1: "Nos da gusto tenerte en",
      p2: "Ya tienes acceso a un espacio moderno para administrar pacientes y diagnósticos.",
      tip: "Tip: completa tu perfil y empieza a agregar tus primeros pacientes cuando inicies sesión.",
